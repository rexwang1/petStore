...
-- Ch 4 Salted User
insert into users(username, password, enabled, salt) values ('admin','admin',true,RAND()*1000000000);
insert into users(username, password, enabled, salt) values ('guest','guest',true,RAND()*1000000000);
